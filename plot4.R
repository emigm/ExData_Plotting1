...
# (1, 1)
with(narrowed_data, plot(Time, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
# (1, 2)
with(narrowed_data, plot(Time, Voltage, type="l", xlab="datetime", ylab="Voltage"))
# (2, 1)
...
# (2, 2)
with(narrowed_data, plot(Time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
